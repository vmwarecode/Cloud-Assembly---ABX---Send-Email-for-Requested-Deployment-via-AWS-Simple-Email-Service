...
#--------------------------------------------------------#
  ...
  # [Subscription]
  #   - Event Topics:
  #      - deployment.request.post: Event is fired after deployment is provisioned for both blueprint and catalog requests . > Runs only for CREATE_DEPLOYMENT event type. 
  # [Thanks]
  #
...
def handler(context, inputs):      # Action entry function.
    ...
    eventType = ""  # Event Type for which the aciton is running
    ...
    print("[ABX] "+fn+" actionOptionRunOnProperty: " + actionOptionRunOnProperty)
    print("[ABX] "+fn+" runOnProperty: " + runOnProperty)
    print("[ABX] "+fn+" eventType: " + eventType )
    print("[ABX] "+fn+" eventTopicId: " + eventTopicId )
    ...
    # Runs only for selected event types
    if ( ((actionInputs['eventType'] == "CREATE_DEPLOYMENT") and (actionInputs['eventTopicId'] == "deployment.request.post")) or (actionInputs['actionOptionAcceptPayloadInput'] == "false")  ):  
    
        print("[ABX] "+fn+" Runnig for eventType: " + eventType)
        ...
        print("[ABX] "+fn+" awsSesSender: " + awsSesSender )
        ...
        print("[ABX] "+fn+" deploymentId: " + deploymentId )
        
        actionInputs['awsSesToRecipient'] = awsSesToRecipient
        print("[ABX] "+fn+" awsSesToRecipient: " + awsSesToRecipient )
        ...
        print("[ABX] "+fn+" deploymentUrl: " + deploymentUrl )
        print("[ABX] "+fn+" awsSesCcRecipient: " + awsSesCcRecipient )
        print("[ABX] "+fn+" awsSesBccRecipient: " + awsSesBccRecipient)        
        print("[ABX] "+fn+" awsSesConfigurationSet: " + awsSesConfigurationSet)
        print("[ABX] "+fn+" awsSesRegion: " + awsSesRegion)
        #print("[ABX] "+fn+" awsSesSubject: " + awsSesSubject)
        ...
        #print("[ABX] "+fn+" awsSesBodyHtml: " + awsSesBodyHtml)
        ...
        if ( ((actionInputs['eventType'] == "CREATE_DEPLOYMENT") and (actionInputs['eventTopicId'] == "deployment.request.post")) or (actionInputs['actionOptionAcceptPayloadInput'] == "false") ):  
            ...
            # runOnProperty eval
            if ((actionInputs['actionOptionRunOnProperty'] == "true") and (runOnProperty in runOnPorpertyMatch)):   # Loop. RunOn eval.
                runOnProperty_eval = "true"
            elif ((actionInputs['actionOptionRunOnProperty'] == "true") and (runOnProperty not in runOnPorpertyMatch)):
        ...
        print("[ABX] "+fn+" Not set to run for eventType: " + actionInputs['eventTopicId'] + " / " + actionInputs['eventType'] +" or based on actionOptionAcceptPayloadInput action option input.")
    # End Function
